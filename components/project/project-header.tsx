        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
            <div className="flex gap-2">
                ...
                <div>
                  ...
                  {
                      project?.description && (
                        <p className="text-sm 2xl:text-lg text-muted-foreground flex items-center gap-2">
                           {project.description}
                            <span
                            className={`px-2 py-1 rounded-full text-xs font-medium border text-white ${getPhaseColor(
                                project.phase
                            )}`}
                            >
                            {project.phase}
